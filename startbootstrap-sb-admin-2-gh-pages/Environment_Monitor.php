...
if (!isset($_SESSION['staff_id']) || !in_array($_SESSION['role'], ['Environment Monitor', 'Manager'])) {
...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="Environment_Monitor.php">
